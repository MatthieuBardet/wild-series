 ...
 */
final class Version20201220130742 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE episode CHANGE synopsis synopsis VARCHAR(10000) DEFAULT NULL');
        $this->addSql('ALTER TABLE season CHANGE program_id_id program_id_id INT DEFAULT NULL, CHANGE year year INT DEFAULT NULL, CHANGE description description VARCHAR(10000) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE episode CHANGE synopsis synopsis LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE season CHANGE program_id_id program_id_id INT NOT NULL, CHANGE year year INT NOT NULL, CHANGE description description LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
